 ...
 *
 * ,--------------------------------------------------.           ,--------------------------------------------------.
 * |  Esc   |   1  |   2  |   3  |   4  |   5  | LEFT |           |insert|   6  |   7  |   8  |   9  |   0  |   -    |
 * |--------+------+------+------+------+-------------|           |------+------+------+------+------+------+--------|
 * |  Tab   |   Q  |   W  |   E  |   R  |   T  | scrl |           |  L1  |   Y  |   U  |   I  |   O  |   P  |   \    |
 * |--------+------+------+------+------+------| lock |           |      |------+------+------+------+------+--------|
 * |  Del   |   A  |   S  |   D  |   F  |   G  |------|           |------|   H  |   J  |   K  |   L  |; / L2|' / Cmd |
 * |--------+------+------+------+------+------| Hyper|           | Meh  |------+------+------+------+------+--------|
 * | LShift |Z/Ctrl|   X  |   C  |   V  |   B  |      |           |      |   N  |   M  |   ,  |   .  |//Ctrl| RShift |
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   |LGui|  '"  |  alt   | Left | Right|                                       |  Up  | Down |   [  |   ]  | ~L1  |
 *   `----------------------------------'                                       `----------------------------------'
 *                                        ,-------------.       ,-------------.
 *                                        | ~L2  | enter|       | pgup |  Esc |
 *                                 ,------|------|------|       |------+--------+------.
...
[BASE] = LAYOUT_ergodox_pretty(
  // left hand
  KC_ESC,          KC_1,        KC_2,          KC_3,    KC_4,    KC_5,    KC_LEFT,             KC_INS,       KC_6,    KC_7,    KC_8,    KC_9,              KC_0,           KC_MINS,
  KC_TAB,          KC_Q,        KC_W,          KC_E,    KC_R,    KC_T,    KC_SCRL,             TG(SYMB),     KC_Y,    KC_U,    KC_I,    KC_O,              KC_P,           KC_BSLS,
  KC_DEL,          KC_A,        KC_S,          KC_D,    KC_F,    KC_G,                                       KC_H,    KC_J,    KC_K,    KC_L,              KC_SCLN,        KC_QUOT,
  KC_LSFT,         CTL_T(KC_Z), KC_X,          KC_C,    KC_V,    KC_B,    ALL_T(KC_NO),        MEH_T(KC_NO), KC_N,    KC_M,    KC_COMM, KC_DOT,            KC_SLSH,        KC_RSFT,
  KC_LGUI,         KC_QUOT,     KC_LALT,       KC_LEFT, KC_RGHT,                                                      KC_UP,   KC_DOWN, KC_LBRC,           KC_RBRC,        TT(SYMB),
                                                                 TT(MDIA),KC_ENT,              KC_PGUP,      KC_ESC,
                                                                          KC_HOME,             KC_PGDN,
                                                        KC_SPC,  KC_BSPC, KC_END,              KC_RCTL,      KC_TAB,  KC_ENT
),
...
[SYMB] = LAYOUT_ergodox_pretty(
  ...
  EE_CLR,  KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,                                         KC_TRNS, KC_DOT,  KC_0,    KC_EQL,  KC_TRNS,
                                               ...
                                               RGB_MOD, KC_APP,      RGB_TOG, RGB_M_P,
                                                        KC_TRNS,     KC_TRNS,
                                      KC_SPC,  KC_BSPC, KC_TRNS,     KC_TRNS, KC_TAB,  KC_ENT
),
//orig
// [SYMB] = LAYOUT_ergodox_pretty(
//   // left hand
...
[MDIA] = LAYOUT_ergodox_pretty(
  ...
  KC_TRNS, KC_TRNS, KC_TRNS, KC_BTN1, KC_BTN2,                                         KC_VOLU, KC_VOLD, KC_MUTE, KC_TRNS, TT(BEPD),

                                               KC_TRNS, KC_TRNS,     KC_TRNS, KC_PSCR,
                                                        KC_TRNS,     KC_TRNS,
